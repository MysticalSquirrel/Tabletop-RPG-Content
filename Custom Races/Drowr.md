...
2. [Shadowthreader (Soon)](../Custom Classes/Drowr Classes/Shadowthreader.md) - Has learned to use the fangs for piercing and applying poison, the legs for slashing as well as crushing.

3. [Bodybreaker (Soon)](../Custom Classes/Drowr Classes/Bodybreaker.md) - Has learned from the true daughters that size and strength is not only for show and tell.

4. [Warden (Soon)](../Custom Classes/Drowr Classes/Warden.md) - The Guardian Disciple has a web of his own covering the entire body.
